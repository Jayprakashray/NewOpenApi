...
/**
 * Links relative to this containing entity
 */
@Schema(description = "Links relative to this containing entity")
...
public class HateoasLinks extends ArrayList<HateoasLink> {
